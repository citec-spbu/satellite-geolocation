...
class Config:
    def __init__(self, model, data_config, pipline_config, lr_config, train_config, test_config, checkpoint_config,
                 log_interval, load_from, resume_from, debug, seed):
        self.model = model
        self.data_config = data_config
        self.pipline_config = pipline_config
