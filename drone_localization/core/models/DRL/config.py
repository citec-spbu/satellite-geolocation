...
model = dict(
    backbone=dict(
        type="MixFormer",
        vit_type="cvt13",
        pretrain_path="/workspace/DRL/pretrained/CvT-13-384x384-IN-22k.pth",
        pretrain=True,
        output_index=[0, 1, 2],
    ),
    neck=dict(
...
data_config = dict(
    ...
    num_worker=8,
    val_batchsize=8,
    train_dir="/workspace/datasets/UL14/map2019/train",
    # val_dir='/workspace/datasets/UL14/map2019/val',
    val_dir="/workspace/datasets/UL14/map2019/val",
    test_dir="/workspace/datasets/UL14/map2019/val",
...
train_config = dict(autocast=True, num_epochs=120)
test_config = dict(
    num_worker=8,
    filterR=31,
